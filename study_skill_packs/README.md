...
V1 keeps these skills declarative. JSON, YAML, and YML files are supported. Custom Python plugins are intentionally out of scope until the local workflow is stable and auditable.
